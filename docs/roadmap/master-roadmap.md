...
| REG-01 | Training Day | Fix stored guest removal oscillation so Saved settles correctly | In progress | P1 | Open in #184; client register state only, no migration, Spond or Edge change |
