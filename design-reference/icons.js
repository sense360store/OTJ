/* ============================================================
   Ossett Training Hub — icon set (inline SVG, stroke-based)
   Exposes window.Icon.<name>
   ============================================================ */
(function () {
  const S = (paths, extra = {}) => (props) => {
    ...
    return React.createElement("svg", {
      ...
      width: size, height: size, ...extra, ...rest,
    }, paths.map((d, i) =>
      typeof d === "string"
  ...
  const L = (x1, y1, x2, y2) => ({ t: "line", p: { x1, y1, x2, y2 } });
  const R = (x, y, w, h, rx) => ({ t: "rect", p: { x, y, width: w, height: h, rx } });
  ...
  window.Icon = {
    ...
    film: S([R(3,4,18,16,3), L(8,4,8,20), L(16,4,16,20), L(3,9.3,8,9.3), L(16,9.3,21,9.3), L(3,14.7,8,14.7), L(16,14.7,21,14.7)]),
    ...
    sun: S([C(12,12,4.5), L(12,2,12,4), L(12,20,12,22), L(2,12,4,12), L(20,12,22,12), L(4.9,4.9,6.3,6.3), L(17.7,17.7,19.1,19.1), L(4.9,19.1,6.3,17.7), L(17.7,6.3,19.1,4.9)]),
    ...
    list: S([L(8,6,21,6), L(8,12,21,12), L(8,18,21,18), C(4,6,.6), C(4,12,.6), C(4,18,.6)]),
    filter: S(["M3 5h18l-7 8v6l-4-2v-4Z"]),
    dumbbell: S([L(6,8,6,16), L(4,9,4,15), L(18,8,18,16), L(20,9,20,15), L(6,12,18,12)]),
    brain: S(["M9 4a3 3 0 0 0-3 3 3 3 0 0 0-1 5 3 3 0 0 0 2 4 3 3 0 0 0 4 1V4Z","M15 4a3 3 0 0 1 3 3 3 3 0 0 1 1 5 3 3 0 0 1-2 4 3 3 0 0 1-4 1V4Z"]),
